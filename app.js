    ...
    .then((data) => {
      data.map((element) => {
        ...
        card.innerHTML = `<div>
                <img src = "">
                <span class = anything>
                    <img src = "https://tse3.mm.bing.net/th?id=OIP.cPMG_aeZDEsBnJ5ZiEDYcQHaE8&pid=Api&P=0&h=220" width = "100px">
...
function update(e) {
  let cardid = e.id;
  let newtitle = prompt("Update The Commit:", "");
  let newcontent = prompt("Update The Title:", "");
